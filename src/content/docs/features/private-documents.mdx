...
import wizardPrivate from '../../../assets/screenshots/wizard-private-documents.png';
...
<Image src={wizardPrivate} alt="Configuration Wizard Private Documents page with two tutorial video cards" />
